            ...
            <div className="glass-card" style={{ marginBottom: '1.5rem', padding: '1.2rem' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(10, 1fr)', gap: '6px' }}>
                    {[...Array(30)].map((_, i) => {
                        ...
                        const bgColors = ['#ECFDF5', '#FFECCF', '#FFB76B', 'var(--domain-orange)'];
                        return (
                            <div key={i} style={{
                                width: '100%',
                                aspectRatio: '1/1',
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '1rem', fontSize: '0.7rem', color: '#888', fontWeight: 600 }}>
                    ...
                    <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
                        {[0, 1, 2, 3].map(i => (
                            <div key={i} style={{ width: '10px', height: '10px', background: ['#ECFDF5', '#FFECCF', '#FFB76B', 'var(--domain-orange)'][i], borderRadius: '2px' }}></div>
                        ))}
                    </div>
