...
const titleStyle: React.CSSProperties = { margin: '0 0 2rem 0', fontSize: '1.4rem', fontWeight: 900, color: '#0F172A', textAlign: 'center' };
...
const inputStyle: React.CSSProperties = { width: '100%', padding: '12px 16px', borderRadius: '14px', border: '2px solid #F0F0F0', fontSize: '0.9rem', fontWeight: 700, outline: 'none', transition: 'border-color 0.2s', color: '#0F172A' };
