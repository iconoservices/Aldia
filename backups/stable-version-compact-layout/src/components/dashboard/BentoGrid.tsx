...
import { Flame, MoreVertical, Play, Pause, RotateCcw, Volume2, VolumeX } from 'lucide-react';
        ...
        <div className="bento-grid">
            ...
            <div className="right-widgets">
                ...
                <div className="mini-widgets-row">
                    ...
                    <div className="glass-card mini-square center-content" style={{ background: 'var(--text-carbon)', color: 'white', flex: 1 }}>
